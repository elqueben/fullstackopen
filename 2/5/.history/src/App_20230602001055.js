...
const NameForm = ({ newName, newNumber, handleNameChange, handlePhoneChange, handleSubmit }) => {
  return (
...
const DisplayNames = ({ persons, numbers, search }) => {
...
const App = () => {
  ...
  return (
    <div>
      ...
      />
      <h2>Numbers</h2>
      <DisplayNames persons={persons} numbers={numbers} search={search} />
